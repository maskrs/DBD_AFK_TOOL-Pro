from PySide6.QtWidgets import QLineEdit, QWidget, QApplication
from PySide6.QtCore import Qt, Signal,  QRectF, QEvent, QTimer
...
class ModernSpinButton(ModernWidget):
    ...
    def __init__(self, text, parent=None):
        ...
        # 使用相对路径
        self._icon = QIcon(":/resources/up_arrow.svg" if self._is_up else ":/resources/down_arrow.svg")
...
class ModernClearButton(ModernWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._is_hovered = False
        self._is_pressed = False
        self._icon = QIcon(":resources/ic_fluent_clear_formatting_regular.svg")
