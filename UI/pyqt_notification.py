...
class ArtisticNotificationContent(QWidget):
    ...
    def _update_style(self):
        ...
        try:
            # 先尝试使用资源文件中的SVG图标
            close_icon_path = ':/resources/picture/ic_fluent_dismiss_regular.svg'
    ...
    def getIcon(level):
        """获取不同级别的图标"""
        icon_map = {
            'info': ':/resources/picture/ic_fluent_info_filled.svg',
            'warning': ':/resources/picture/ic_fluent_warning_filled.svg',
            'error': ':/resources/picture/ic_fluent_dismiss_circle_filled.svg',
            'success': ':/resources/picture/ic_fluent_checkmark_circle_filled.svg'
        }
